...
class ResultUdemae(StatefulScene):
    ...
    def _state_tracking(self, context):
        ...
        if not self.matched_in(context, 30 * 1000, attr='_last_event_msec'):
            ...
            context['scenes']['result_udemae']['udemae_str'] = game['result_udemae_str_pre']
            context['scenes']['result_udemae']['udemae_exp'] = game['result_udemae_exp_pre'] 
            context['scenes']['result_udemae']['udemae_str_after'] = game['result_udemae_str']
            context['scenes']['result_udemae']['udemae_exp_after'] = game['result_udemae_exp'] 
            # <<<<<
    ...
    def dump(self, context):
        ...
        print(
            ...
            game['result_udemae_str_pre'],game['result_udemae_exp_pre'],
            game['result_udemae_str'],game['result_udemae_exp'],
        ))
