...
from ikalog.scenes.result_udemae2 import ResultUdemae as ResultUdemae2
from ikalog.scenes.result_gears2 import ResultGears2
...
#        self.scn_tower_tracker.reset(context)
    ...
    def process_frame(self):
        ...
        context['engine']['inGame'] = self.find_scene_object('GameTimerIcon').match(context)
